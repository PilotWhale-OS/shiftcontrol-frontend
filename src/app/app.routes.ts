...
import {
  ...
  BC_SHIFT_CALENDAR,
  BC_SHIFT_DETAILS,
  BC_PLAN_ONBOARDING, BC_EVENT_EDIT, BC_EVENT_CREATE, BC_PLAN_CREATE, BC_PLAN_EDIT, BC_EVENT_SCHEDULE
} from "./breadcrumbs";
...
export const routes: Routes = ([
  ...
  /* shiftplans */
  { path: "events/:eventId/create-plan", component: ManageShiftPlanComponent,
    data: { breadcrumbs: BC_PLAN_CREATE }, canActivate: [accessAllowedGuard]},
